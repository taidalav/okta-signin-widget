...
Renders the widget to the DOM to prompt the user to sign in using opinionated defaults. On successful authentication, users are redirected back to the application via the `redirectUri` with an Okta SSO session, access and/or identity tokens.
